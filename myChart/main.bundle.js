...
var BasicChartComponent = (function () {
    ...
    BasicChartComponent.prototype.getDetail = function (del) {
        ...
        switch (del.type) {
            ...
            case 12:
                ...
                break;
            case 96:
                var data = option.series[this.item.seriesIndex].data[this.item.dataIndex] || '';
                if (!data)
                    return;
    ...
    BasicChartComponent.prototype.changeItemColor = function () {
    ...
    BasicChartComponent.prototype.reDraw = function () {
        this.myChart.clear();
